...
interface IPageInstance {
  onAACTInput(e: WechatMiniprogram.Input): void;
  onMMSEInput(e: WechatMiniprogram.Input): void;
  onVFTInput(e: WechatMiniprogram.Input): void;
  onDPNChange(e: WechatMiniprogram.CustomEvent): void;
  calculateRisk(): void;
  resetForm(): void;
}
